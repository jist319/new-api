...
func InitOptionMap() {
	...
	common.OptionMap["RedemptionCodeLink"] = common.RedemptionCodeLink
	common.OptionMap["TutorialDoc"] = common.TutorialDoc
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "RedemptionCodeLink":
		common.RedemptionCodeLink = value
	case "TutorialDoc":
		common.TutorialDoc = value
	//case "ChatLink":
